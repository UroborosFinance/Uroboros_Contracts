...
contract WBNBBondDepository is Ownable {
    ...
    address public immutable treasury; // mints SNAKE when receives principle
    ...
    struct Bond {
        uint payout; // SNAKE remaining to be paid
    ...
    function deposit( 
        ...
        require( payout >= 10000000, "Bond too small" ); // must be > 0.01 SNAKE ( underflow protection )
    ...
    /**
     *  @notice calculate current ratio of debt to SNAKE supply
    ...
    /**
     *  @notice calculate amount of SNAKE available for claim by depositor
     *  @param _depositor address
    ...
    /**
     *  @notice allow anyone to send lost tokens (excluding principle or SNAKE) to the DAO
     *  @return bool
     */
